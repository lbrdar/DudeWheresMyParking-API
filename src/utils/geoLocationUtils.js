const GeoLocation = {
  ...
  distanceFromRadian: (location1, location2) => {
  ...
  distanceFromDegree: (location1, location2) => {
    const loc1 = {
      radLat: GeoLocation.degreeToRadian(location1.latitude),
      radLon: GeoLocation.degreeToRadian(location1.longitude),
    };
    const loc2 = {
      radLat: GeoLocation.degreeToRadian(location2.latitude),
      radLon: GeoLocation.degreeToRadian(location2.longitude),
    };
    return GeoLocation.distanceFromRadian(loc1, loc2);
  }
};
